...
async function loadCarList() {
    try {
        ...
        if (searchQuery) {
            response = await axios.get(`http://13.124.146.78:8080/api/cars/search`, {
                params: {
                    size: itemsPerPage,
                    page: currentPage - 1,
                    sort: 'id,desc',
            ...
            response = await axios.get(`http://13.124.146.78:8080/api/cars/carList`, {
                params: {
                    size: itemsPerPage,
                    page: currentPage - 1,
                    sort: 'id,desc'
...
async function deleteCar(carId) {
    try {
        await axios.delete(`http://13.124.146.78:8080/api/admin/car/${carId}`, {
            headers: {
